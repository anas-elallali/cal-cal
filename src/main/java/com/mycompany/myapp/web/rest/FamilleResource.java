...
import com.mycompany.myapp.service.FamilleService;
...
public class FamilleResource {
     ...
     */
    @GetMapping("/familles")
    public ResponseEntity<List<Famille>> getAllFamilles(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
